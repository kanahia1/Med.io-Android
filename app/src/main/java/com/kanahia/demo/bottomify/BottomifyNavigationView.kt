...
//        }
    ...
    private fun selectItem(navigationItem: NavigationItem, withClickSound: Boolean) {
        ...
        selectedNavigationItem.textView.setTextColor(Color.parseColor(params.passiveColor))
        selectedNavigationItem.imageView.setColorFilter(Color.parseColor(params.passiveColor))
        ...
        navigationItem.textView.setTextColor(Color.parseColor(params.activeColor))
        navigationItem.imageView.setColorFilter(Color.parseColor(params.activeColor))
    ...
    private fun colorAnim(navigationItem: NavigationItem, activeToPassive: Boolean) {
        ...
        val colorActive = if (navigationItem.view == navigationItems[selectedPosition].view) Color.parseColor(params.activeColor) else Color.parseColor(params.passiveColor)
        val colorPassive = Color.parseColor(params.pressedColor)
        ...
        if (navigationItem.view == navigationItems[selectedPosition].view && !activeToPassive) {
            colorTo = Color.parseColor(params.activeColor)
        }
